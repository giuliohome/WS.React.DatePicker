...
(function()
{
 ...
 SPA_Templates=Global.SPA_Templates=Global.SPA_Templates||{};
 Handler=Server.Handler=Server.Handler||{};
 Var=UI.Var=UI.Var||{};
 ReactHook=Global.ReactHook=Global.ReactHook||{};
 React=ReactHook.React=ReactHook.React||{};
 ...
 Html=React$1.Html=React$1.Html||{};
 ...
 React$2=Global.React;
 Date=Global.Date;
 console=Global.console;
 Math=Global.Math;
 Client.Main=function()
 {
  var newName,a,b,t,_this,L,_this$1,p,i,a$1,x;
  ...
  a=(b=(t=(_this=(L=Doc.Convert(function(name)
  {
   ...
   return(b$1=(_this$2=new ProviderBuilder.New$1(),(_this$2.h.push({
    ...
    $0:"name",
    $1:name
   }),_this$2)),(p$1=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i$1=new TemplateInstance.New(p$1[1],SPA_Templates.listitem(p$1[0])),b$1.i=i$1,i$1))).get_Doc();
  ...
  },function()
  {
   ...
   newName.Set("");
  })),t)),(p=Handler.CompleteHoles(b.k,b.h,[["name",0]]),(i=new TemplateInstance.New(p[1],SPA_Templates.main(p[0])),b.i=i,i))).get_Doc();
  Templates.LoadLocalTemplates("");
  Doc.RunById("main",a);
  a$1=Doc.Element("div",[],[Doc.Element("p",[],[Doc.TextView((x=Client.count().get_View(),View.Map(function($1)
  {
   return function($2)
   {
  ...
  }(Global.id),x)))]),Doc.Element("button",[AttrProxy.HandlerImpl("click",function()
  {
   return function()
   {
    ...
    return(React.setCount())(next);
   };
  })],[Doc.TextNode("W# UI Click Me!")]),Doc.Element("div",[AttrProxy.OnAfterRenderImpl(function(el)
  {
   ReactDOM.render(React.FunctionComponent(HelloWorld.Example,null),el);
  })],[])]);
  Templates.LoadLocalTemplates("");
  Doc.RunById("mainUI",a$1);
 };
 ...
 SPA_Templates.listitem=function(h)
 {
 ...
 React.setCount=function()
 {
  SC$1.$cctor();
  return SC$1.setCount;
 };
 React.FunctionComponent=function(f,props)
 {
 ...
 HelloWorld.Example=function()
 {
  ...
  setCount=p[1];
  count=p[0];
  p$1=React$2.useState(new Global.moment(new Global.Date((c=Date.now(),DateUtil.DatePortion(c)))));
  myDate=p$1[0];
  datePicker=React$2.createElement(Global["eval"]("DatePicker.default"),{
   selected:myDate,
   onChange:p$1[1]
  });
  ...
  }))(count)),React$2.createElement("button",{
   onClick:function()
   {
    setCount(count+1);
 ...
 {
  return React$2.createElement(name,props,ReactModule.inlineArrayOfSeq(children));
 };
