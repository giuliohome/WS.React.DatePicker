...
{
 "use strict";
 var Global,SPA,Client,WebSharper,Operators,Obj,UI,Var,ReactHook,WrapReact,HelloWorld,React,ReactModule,View,AttrProxy,SC$1,Doc,JavaScript,Pervasives,Html,Utils,UIBase,MyVars,Arrays,JS,Client$1,Templates,Snap,Attrs,Var$1,DomUtility,Unchecked,EventTarget,WindowOrWorkerGlobalScope,Node,Collections,Dictionary,ConcreteVar,DateUtil,SC$2,HashSet,Seq,Docs,Elt,Array,Abbrev,Fresh,DocElemNode,CharacterData,Enumerator,DictionaryUtil,Object,Prepare,Slice,KeyCollection,Numeric,An,Settings,Mailbox,Updates,List,T,Attrs$1,Dyn,Strings,Docs$1,RunState,NodeSet,Concurrency,Anims,SC$3,Queue,SC$4,SC$5,T$1,SC$6,SC$7,AppendList,HashSetUtil,BindVar,String,CheckedInput,Scheduler,Easing,AsyncBody,SC$8,CT,HashSet$1,Char,CancellationTokenSource,DomNodes,Error,OperationCanceledException,Lazy,SC$9,LazyExtensionsProxy,LazyRecord,ReactDOM,IntelliFactory,Runtime,React$1,Date,console;
 Global=self;
 ...
 Var=UI.Var=UI.Var||{};
 ReactHook=Global.ReactHook=Global.ReactHook||{};
 WrapReact=ReactHook.WrapReact=ReactHook.WrapReact||{};
 HelloWorld=ReactHook.HelloWorld=ReactHook.HelloWorld||{};
 ...
 {
  var a,x;
  a=Doc.Element("div",[],[Doc.Element("p",[],[Doc.TextView((x=Client.count().get_View(),View.Map(function($1)
  {
   return function($2)
   {
    return $1("You clicked "+Global.String($2)+" times");
   };
  }(Global.id),x)))]),Doc.Element("button",[AttrProxy.HandlerImpl("click",function()
  {
   return function()
   {
    var next;
    next=Client.count().Get()+1;
    Client.count().Set(next);
    return(WrapReact.setCount())(next);
   };
  })],[Doc.TextNode("W# UI Click Me!")]),Doc.Element("div",[AttrProxy.OnAfterRenderImpl(function(el)
  {
   ReactDOM.render(WrapReact.FunctionComponent(HelloWorld.Example,null),el);
  })],[])]);
  Templates.LoadLocalTemplates("");
  Doc.RunById("mainUI",a);
 };
 ...
 WrapReact.setCount=function()
 {
  SC$1.$cctor();
  return SC$1.setCount;
 };
 WrapReact.FunctionComponent=function(f,props)
 {
  return React$1.createElement(f,props);
 };
 WrapReact.set_setCount=function($1)
 {
  SC$1.$cctor();
  SC$1.setCount=$1;
 };
 HelloWorld.Example=function()
 {
  ...
  p=React$1.useState(0);
  setCount=p[1];
  count=p[0];
  p$1=React$1.useState(new Global.Date((c=Date.now(),DateUtil.DatePortion(c))));
  myDate=p$1[0];
  datePicker=React$1.createElement(Global["eval"]("window.MyDatePicker"),{
   selected:myDate,
   onChange:p$1[1],
   showTimeSelect:true
  });
  WrapReact.set_setCount(setCount);
  return React$1.createElement("div",null,datePicker,React$1.createElement("p",null,((Html.textf(Runtime.Curried3(function($1,$2,$3)
  {
   return $1("You selected "+Utils.toSafe($2)+" date "+Utils.toSafe($3)+" time");
  })))(myDate.toDateString()))(myDate.toTimeString())),React$1.createElement("p",null,(Html.textf(function($1)
  {
   return function($2)
   {
    return $1("You clicked "+Global.String($2)+" times");
   };
  }))(count)),React$1.createElement("button",{
   onClick:function()
   {
    setCount(count+1);
    MyVars.count().Set(count+1);
   }
  },"W# React Click me"));
 };
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.count=Var$1.Create$1(0);
  SC$1.setCount=Global.ignore;
  SC$1.count$1=MyVars.count();
 };
 ...
 SC$4.$cctor=function()
 {
  ...
  SC$4.EmptyAttr=null;
  SC$4.BoolCheckedApply=Runtime.Curried3(function(_var,el,cb)
  {
  ...
  SC$4.StringApply=(g=BindVar.StringGet(),(s=BindVar.StringSet(),Runtime.Curried(BindVar.ApplyValue,3,[g,function($1,$2)
  {
   return(s($1))($2);
  }])));
  ...
  SC$4.IntApplyUnchecked=(g$1=BindVar.IntGetUnchecked(),(s$1=BindVar.IntSetUnchecked(),Runtime.Curried(BindVar.ApplyValue,3,[g$1,function($1,$2)
  {
   return(s$1($1))($2);
  }])));
  ...
  SC$4.IntApplyChecked=(g$2=BindVar.IntGetChecked(),(s$2=BindVar.IntSetChecked(),Runtime.Curried(BindVar.ApplyValue,3,[g$2,function($1,$2)
  {
   return(s$2($1))($2);
  }])));
  ...
  SC$4.FloatApplyUnchecked=(g$3=BindVar.FloatGetUnchecked(),(s$3=BindVar.FloatSetUnchecked(),Runtime.Curried(BindVar.ApplyValue,3,[g$3,function($1,$2)
  {
   return(s$3($1))($2);
  }])));
  ...
  SC$4.FloatApplyChecked=(g$4=BindVar.FloatGetChecked(),(s$4=BindVar.FloatSetChecked(),Runtime.Curried(BindVar.ApplyValue,3,[g$4,function($1,$2)
  {
   return(s$4($1))($2);
  }])));
 };
